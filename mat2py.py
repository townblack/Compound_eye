...
cwd = os.getcwd()
compoundData = h5py.File(cwd+"/PASCAL_VOC_2012/10/compoundData_test.mat")
compoundData.keys()
compoundData_seg = h5py.File(cwd+"/PASCAL_VOC_2012/10/compoundData_seg_test.mat")
...
# np.save(cwd+'/PASCAL_VOC_2012/20/compoundData_test.npy', compoundData)
# np.save(cwd+'/PASCAL_VOC_2012/20/compoundData_seg_test_manual.npy', region_val)
np.save(cwd+'/PASCAL_VOC_2012/10/compoundData_gt_test.npy', compoundData_gt)
